...
const roleRoutes: Record<string, string> = {
  CEO: "/dashboard",
  // BranchManager: "/HRdashboard",
  Director: "/HRdashboard",
};
...
export default function Login() {
  ...
  const handleLogin = async (e: FormEvent) => {
    ...
    try {
      ...
      // ✅ Redirect using mapping (no if/else)
      const route = roleRoutes[role] || "/default-dashboard";
      navigate(route);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f0e3cf] px-4">
      <div className="w-full max-w-md p-8 space-y-6 bg-white shadow-lg rounded-2xl">
        {/* Logo */}
        <img src="/image.png" alt="CamelQ Logo" className="w-24 mx-auto" />
